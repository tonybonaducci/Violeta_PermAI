...
def fcv_5(full_set, n_examples, part_lengths,atributes,i,set_type,seed):
      ...
      f_test, c_test, r_test = utilities.weighted_fitness_function(test_data,test_labels,cromosoma)
      ...
      f_f, c_r, r_r = utilities.utilities.weighted_fitness_function(train_set,test_set,test_set_size,clasificacion,weights)
      ...
      f_f, c_r, r_r = utilities.utilities.weighted_fitness_function(train_set,test_set,test_set_size,clasificacion,relief_weights)
