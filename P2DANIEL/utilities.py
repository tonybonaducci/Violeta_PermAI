...
def select_partition(full_set, n_examples, part_lengths, i,set_type,atributes):
        ...
        if (j > i):
            ...
            for k in range(part_lengths[j]):
                ...
                for atribute in atributes: 
                    ...
                    train_set[atribute][last_pos_train + k] = full_set[atribute][ last_pos_train + test_set_size + k]
                    #print("Añadimos el valor ",train_set[atribute][last_pos_train + k]," en la posicion ",last_pos_train + k," del train set")

                train_set['class'][last_pos_train + k] = full_set['class'][ test_start_pointer + test_set_size + k]
    ...
    #for i in range(train_set_size):
        #print(train_set[i])
    #print("Devolvemos test labels: ",test_labels)
